# -*- coding: utf-8 -*-
"""
Created on Sun Jan  9 00:25:12 2022
...
# Build model
model_loaded = Model(inputs=[x_in, phsi_in, phsiIn_in, a_in], outputs=gc_2)
...
eval_results = model_loaded.evaluate(loader_te_load, steps=1)
