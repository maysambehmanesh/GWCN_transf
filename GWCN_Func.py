...
def data_loader(dataset,sample_weights):
    """
    Parameters
    ----------
...
def computeLoaderCombine(dataset,mask_tr,mask_va,mask_te,appriximate_phsi,N_scales,scales,m,epochs,thr):
    ...
    itrData=data_loader(dataset,sample_weights)
